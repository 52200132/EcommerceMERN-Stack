...
export { default as productDetailsReducer } from './product-details-slice';
export { default as userProfileReducer } from './user-profile-slice';

export * from './product-slice';
export * from './modal-slice';
export * from './component-action-slice';
export * from './auth-slice';
export * from './product-details-slice';
export * from './user-profile-slice';