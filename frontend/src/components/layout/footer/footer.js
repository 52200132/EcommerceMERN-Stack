            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer f-contact">
                  ...
                  <p className="mail">
                    <Link to="mailto:support@shopgrids.com">support@shopgrids.com</Link>
                  </p>
                </div>
                {/* End Single Widget */}
              </div>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer f-link">
                  ...
                  <ul>
                    <li><Link to="/category/computers">Computers & Accessories</Link></li>
                    <li><Link to="/category/smartphones">Smartphones & Tablets</Link></li>
                    <li><Link to="/category/tv">TV, Video & Audio</Link></li>
                    <li><Link to="/category/cameras">Cameras, Photo & Video</Link></li>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-4 col-12">
                <div className="copyright">
                  <p>Designed and Developed by <Link to="#">Your Company</Link></p>
                </div>
              </div>
              <div className="col-lg-4 col-12">
                <ul className="socila">
