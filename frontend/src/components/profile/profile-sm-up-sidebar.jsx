...
const navSchema = [
  { id: 'notifications', label: 'Thông Báo', icon: <BsBell />, editable: false },
  {
    ...
    icon: <BsPersonCircle />,
    children: [
      { id: 'profile', label: 'Hồ Sơ', icon: <BsPerson />, link: '/user-info/profile' },
      { id: 'addresses', label: 'Địa Chỉ', icon: <BsGeoAlt />, link: '/user-info/addresses' },
      { id: 'password', label: 'Đổi Mật Khẩu', icon: <BsShieldLock />, link: '/user-info/password-change' },
    ],
  },
  { id: 'orders', label: 'Đơn Mua', icon: <BsBagCheck />, editable: false },
